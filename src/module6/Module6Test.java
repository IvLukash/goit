...
public class Module6Test {
    public static void main(String[] args) {
        ...
        //  *** CircleIntersector ***
        //System.out.println(new CircleIntersector(5, 7, 1, 0, 7, 5));
        ...
        //Level.LevelInfo info = new Level.LevelInfo("Quarke Outro", "Very difficult");
        //Level level = new Level(info, points);
        //System.out.println(level);
        //System.out.println(level.calculateLevelHash());
    }
}
